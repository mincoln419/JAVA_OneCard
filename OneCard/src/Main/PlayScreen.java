...
public class PlayScreen extends Frame implements Runnable, ActionListener{
   ...
   public static Button oneCard=new Button("원카드");
      ...
      case 0:
		...
		case 1:
			...
			nname3.setText(Client.readyMember.get(3));
			 for(int i=7;i<14;i++){
		          mylist.add(tl.sumlist.get(i));
		          mylist.get(i-7).setEnabled(false);//my card 못건들게 
		       }
			break;
		case 2:
			nname1.setText(Client.readyMember.get(0));
			...
			nname3.setText(Client.readyMember.get(3));
			 ...
			 for(int i=14;i<21;i++){
		          mylist.add(tl.sumlist.get(i));
		          mylist.get(i-14).setEnabled(false);//my card 못건들게 
		       }
			 break;
		case 3:
			nname1.setText(Client.readyMember.get(0));
			...
			for(int i=21;i<28;i++){
		          mylist.add(tl.sumlist.get(i));
		          mylist.get(i-21).setEnabled(false);//my card 못건들게 
		       }
